<!DOCTYPE html>
    <html>
        <head>
            <meta charset="<?php bloginfo('charset');?>"><!-- La fonction bloginfo() affiche des informations concernant le site, ici le charset du site-->

            <title><?php bloginfo('name');?></title><!-- affiche le nom du site définie dans le BO > réglages>général>titre du site -->

            <!-- Lien vers CSS de bootstrap -->
            <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">

            <!-- CSS du theme  -->
            <link rel="stylesheet" href="<?php bloginfo('template_directory');?>/style.css"> <!-- la fonction affiche le chemin du dossier du theme actif dans lequel on est, ici eprojet  -->
    ...
    <body <?php body_class();?>><!-- affiche les classses du body propres à WP -->
      <header>
            ...
            <div class="container">
                <div class="row" style="width:100%;">
                    ...
                    <div class="navbar-brand col-lg-3">
                        ...
                        <a href="<?php bloginfo('url');?>"><?php bloginfo('name');?></a><!-- affiche l'url principal du site définie dans BO>réglages>général>url -->
...
?>
    ...
    ?>
						            ...
						            <div id="entete" class="align-items-center">
						                <div class="container">
						                    <?php dynamic_sidebar('region-entete'); // on appelle la zone de widget d'id "region-entete" déclartée dans functions.php?>
						                </div>
						            </div>
