...
class MembreController extends Controller
{
    ...
    public function inscriptionAction( Request $request){
        ...
        // Le createBuilder a besoin de deux infos : Quel genre de formulaire, et dex à quelle entité est lié mon formulaire...
        ...
        $formBuilder 
                ...
                // Apres avoir configurer notre formulaire, on le récupère.



        // Traitement des info du formulaire :
            ...
            if($form -> isSubmitted() && $form -> isValid()){
                ...
                $request -> getSession() -> getFlashBag() -> add('success', 'Félicitation ' . $membre -> getPseudo() . ', vous êtes inscrit !');
        ...
        return $this -> render(
            '@Boutique/Membre/form.html.twig', $params);
    }
    ...
    public function updateProfilAction(Request $request){
        ...
        $form -> handleRequest($request);
        // A partir de maintenant notre object $membre contient les infos saisies dans le formulaire.
