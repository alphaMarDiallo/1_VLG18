...
class Produit
{
     ...
     */
    private $photo; // nom de la photo stock é en BBD
	
	private $file; // On ne mappe pas $file, car n'a pas vocation à être enregistrer en BDD. Elle repérente la photo (en tant que data)
	...
	public function uploadPhoto(){
		...
		//3 : Stocker le nnom de la photo dans $photo pour que l'info soit enregistrée en BDD : 
	...
	public function renameFile($nom){
		...
		// Transforme le nom de la photo de la manière suivante : 
			// ex : tshirt.jpg
			// Devient : photo_1565363534_543_tshirt.jpg
	}
