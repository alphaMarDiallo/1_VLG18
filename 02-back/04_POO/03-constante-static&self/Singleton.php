...
class Singleton
{
    ...
    {} // La classe N'EST PAS INSTANCIABLE car le construct est privé !!
    private function __clone(){}// permet que l'objet ne soit pas clonable

    public static function getInstance()
    {

        if (is_null(self::$instance)) { // SI $instance est null, ce qui est le cas la première fois.  Toutes les autres fois, je ne rentre pas dans le 'if' car il y a maintenant un onjet dans $instance
...
//$s = new Singleton; // ERREUR normal car la fonction  __ construct() est en privé !!
...
echo $objet1->numero . '<br>'; // 36 // Tous les représentants de l'objet on cette valeur puisqu'il s'agit du même objet
